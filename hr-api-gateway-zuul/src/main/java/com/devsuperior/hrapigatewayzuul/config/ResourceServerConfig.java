...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    // Todos os caminhos definidos em PUBLIC terão permissão para acessar mesmo sem
    // estar logado
...
// anyRequest().authenticated() - qualquer outra rota que não esta configurada
// exige que o usuário esteja autenticado
// hasAnyRole - consegue acessar as rotas somente no método GET